#' Create an RNA-seq data samplesheet for bagPipes
#'
...
rna_samplesheet <- function(Project, Cell_Type, Genotype, Treatment, Time, Bio_Rep, nSamples, nReps,
  ...
  samplesheet <- data.frame(Project, Cell_Type, Genotype, Bio_Rep,
                            Tech_Rep, Read1, Read2, Sequencing_Directory) |>
    readr::write_tsv(paste0(here::here(), "/RNAsamplesheet.txt"))
